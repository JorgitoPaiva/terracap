 ...
 * 
 */
class KpiTerracap extends CFormModel {
    ...
    public function rptKPIINS02(){
        $tickets = Yii::app()->dbTERRACAP->createCommand()
    ...
    /**
     * Relatório Chamados INS03.
     * @return array
     */
    public function rptKPIINS03(){
        $tickets = Yii::app()->dbTERRACAP->createCommand()
            ->select("id, ticket, tipo, titulo, servico, service_id, ticket_priority_id, prioridade, status, sla, sla_id,
                ...
                tempo_pendente, tempo_atendimento, tempo_filas_terracap, tempo_aberto")
            ->from("vw_ins_03 ")
            ->where("date(data_resolucao) BETWEEN '".FksFormatter::StrToDate($this->dtInicio)."' AND '".FksFormatter::StrToDate($this->dtTermino)."' "
                . "AND queue_id_resolucao NOT IN (4,5,6,16,17,18)"
                . "ORDER BY ticket ASC ")
            ->queryAll();
    ...
    public function rptKPIINS07(){
        ...
        $qtd_srv = Yii::app()->dbTERRACAP->createCommand()
    ...
    public function rptKPI0203(){
        $qtd_in = Yii::app()->dbTERRACAP->createCommand()
        ...
        $qtd_total = Yii::app()->dbTERRACAP->createCommand()
    ...
    public function rptKPITeste(){
        ...
        $resultSet = Yii::app()->dbTERRACAP->createCommand($sql)->queryAll();
